...
function ShowMsg($msg,$gourl,$onlymsg=0,$limittime=0)
{
      ...
      function JumpUrl(){
        if(pgo==0){ location='$gourl'; pgo=1; }
			...
			$rmsg = $func;
			$rmsg .= "document.write(\"<br/><div style='width:400px;padding-top:4px;height:24;font-size:10pt;border-left:1px solid #547ac7;border-top:1px solid #547ac7;border-right:1px solid #547ac7;background-color:#668cd8;'>志友蓝海进销存进销存提示信息：</div>\");\r\n";
