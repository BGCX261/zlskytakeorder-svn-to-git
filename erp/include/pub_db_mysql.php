...
class DedeSql
{
	...
	function Open($pconnect=false)
	{
		...
		if(!$this->linkID){
			//echo $this->GetError();
			$this->DisplayError("志友蓝海错误警告：<font color='red'>连接数据库失败，可能数据库密码不对或数据库服务器出错，如未安装本系统，请先运行安装程序，如果已经安装，请检查MySQL服务或修改include/config_base.php的配置！</font>");
			exit();
		}
	...
	function DisplayError($msg)
	{
		...
		echo "<title>志友蓝海进销存 Error Track</title>\r\n";
		echo "</head>\r\n";
