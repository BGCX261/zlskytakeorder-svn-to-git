...
$showsql="select * from takeorder_tmp_order_detail inner join takeorder_menu_list on takeorder_menu_list.k_id=takeorder_tmp_order_detail.menu_id where 1=1 ";
	if($_GET['k_id']){
