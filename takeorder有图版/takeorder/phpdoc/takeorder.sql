...
(320, 182, 1, 5, 1, 0, 0.00),
(321, 182, 1, 7, 1, 0, 0.00);
...
INSERT INTO `takeorder_tmp_order_main` (`k_id`, `table_id`, `order_time`, `price`, `status`, `order_no`, `pay_status`) VALUES
(182, 2, 1250930089, 0.00, '0', '', '0');
