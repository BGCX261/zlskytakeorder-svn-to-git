...
<ol class="dp-c">
    <li class="alt"><span><span class="keyword">if</span><span>&nbsp;(</span><span class="vars">$base</span><span>[</span><span class="string">\'remote_open\'</span><span>])&nbsp;{ &nbsp;&nbsp;</span></span></li>
    <li class=""><span>&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="vars">$uinfo</span><span>&nbsp;=&nbsp;</span><span class="func">parse_url</span><span>(</span><span class="vars">$base</span><span>[</span><span class="string">\'url\'</span><span>]); &nbsp;&nbsp;</span></li>
