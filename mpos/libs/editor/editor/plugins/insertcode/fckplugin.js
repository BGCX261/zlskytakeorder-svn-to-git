...
//
dp.sh.RegexLib = {
	PaginationLineCComments : new RegExp('/\\*[\\s\\S]*?\\*/', 'gm'),
...
dp.sh.Brushes.Sql = function()
{
	...
	this.regexList = [
		{ regex: new RegExp('--(.*)$', 'gm'),						css: 'comment' },			// one line and Paginationline comments
...
dp.sh.Brushes.Php = function()
{
	var funcs	=	'abs acos acosh addcslashes addslashes ' +
					...
					'array_merge array_merge_recursive array_Paginationsort array_pad array_pop array_product '+
	...
	this.regexList = [
		...
		{ regex: dp.sh.RegexLib.PaginationLineCComments,					css: 'comment' },			// Paginationline comments
		{ regex: dp.sh.RegexLib.DoubleQuotedString,					css: 'string' },			// double quoted strings
		{ regex: dp.sh.RegexLib.SingleQuotedString,					css: 'string' },			// single quoted strings
...
dp.sh.Brushes.Delphi = function()
{
	...
	this.regexList = [
		{ regex: new RegExp('\\(\\*[\\s\\S]*?\\*\\)', 'gm'),		css: 'comment' },  			// Paginationline comments (* *)
		{ regex: new RegExp('{(?!\\$)[\\s\\S]*?}', 'gm'),			css: 'comment' },  			// Paginationline comments { }
...
//		{ regex: new RegExp('(?<!/)//(?!/).*$|(?<!/)////(?!/).*$|/\\*[^\\*]*(.)*?\\*/', 'gm'),	css: 'comment' },			// one line comments starting with anything BUT '///' and Paginationline comments
