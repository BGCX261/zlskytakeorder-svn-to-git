...
/* 提示信息 */
$_LANG['has_locked_installer'] = '<strong>安装程序已经被锁定。</strong><br /><br />如果您确定要重新安装 ，请删除data目录下的 install.lock。';
...
$_LANG['install_done_title'] = '安装程序 安装成功';
$_LANG['install_error_title'] = '安装程序 安装失败';
$_LANG['done'] = '恭喜您，已经成功地安装完成。<br />基于安全的考虑，请在安装完成后删除 install 目录。';
$_LANG['go_to_view_my_ecshop'] = '前往首页';
$_LANG['go_to_view_control_panel'] = '前往后台管理中心';
