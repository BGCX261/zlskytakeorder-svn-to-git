...
var url="<?php echo __ROOT__?>/admin.php";
$(function(){
...
.btn {
	...
	background:#fff url("<?php echo config('ROOT_IMG')?>/default/btn-overlay.png") repeat-x !important;
}
...
<center>
    <form style="margin-top:200px;" action="" method="post">
    <table width="60%" border="0" cellspacing="0" cellpadding="3">
      <tr>
        <th colspan="2" scope="row"><?php echo config('TITLE') ?></th>
        </tr>
      <tr>
        <th scope="row">用户名</th>
      ...
      <tr style="display:none">
        <th scope="row">验证码</th>
        <td><input class="text" name="verify_code" type="text" value="" maxLength=4 size=10 /> <img style="margin:0px; padding:0px;" align="absmiddle"  src="<!--{$url.Default_VerifyCode}-->" /></td>
      </tr>
      <tr>
